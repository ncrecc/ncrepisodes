...
var jester_damage_pool = ["Bumpbomb", "Hijack", "Sharpened Rosary", "Smart Spike", "Breaking Point", "Magic Cyanide", "Throwing Axe", "Supervolcano", "Spin Attack", "Sharp Straw", "Bass Guitar", "Ouija Board", "Holy Water", "Shiver Star"];
...
hammerup = false; //remove once https://github.com/TerryCavanagh/diceydungeons.com/issues/1840 is addressed
...
if (finalboss == "Drake"){
  items.push("Silver Sword,Silver Sword");
}
