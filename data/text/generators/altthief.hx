...
var manamakers = shuffle(["Flower Pot","Daffodil","Snapdragon"]);

items = [manamakers.pop()];
...
commonlist1.push(manamakers.pop());
commonlist1 = shuffle(commonlist1);

var countdowns = shuffle(["Glitter Bomb","Locket","Sceptre"]);
...
commonlist1.push(countdowns.pop());
commonlist1 = shuffle(commonlist1);
...
var commonlist2 = [pick(["Lightreaver", "Bop Bop"]), "Reverse Emulation", "Lucky Charm", "Forty Cakes", "Pirate a Better Version", "Honeysuckle", "Gas Lamp", "Telephone", "Cookie Cake", "Blacklight", lockpickvariant1];
...
commonlist2.push(countdowns.pop());
commonlist2.push(manamakers.pop());
commonlist2 = shuffle(commonlist2);
