...
var commonlist1 = ["Paint Can", "Bumper Sticker", "Hourglass", "Sheer Will", "Gizmotron", "Leather Armor", "Bump", "Healing Crystal", "Lockpick", pick(["Spike", "Long Metal Spike"]), "Keyblade", "Hi Vis Jacket", "Saw Wave", "Elastic Heart", "Berlin Key", "Double Edge", pick(["Blast Chiller", "Cremator"]), "Tetraphobia", spearswing, "Sharp Straw", basics.pop(), "Icebox", "Ice Nine", "Sacrificial Blade@3", pick(["Berlin[comma] Massachusetts Key", "Table Flip"]), "Cubby", "Broadkunai"];
...
var shoplist1 = ["Nail", "Whiskey", "Power Glove", "Crush Together", "Survivor's Guilt", "Radio Dial", "Wail Bat", "Autohook", "Virtue Grip", basics.pop(), "Lightstick", "No Pain No Gain", "Berliner", "Tragic Entrance", "Buzzsaw", "Smartwatch", "Bronze Dagger", "Dagger", "Boomerang", "Crystal Sword", "Venus Fly Trap", "Keyblade", "Nunchucks", "Big Stick", "Rubber Mallet", "Change Machine", "Screwdriver", "Giant Spatula", pick(["Gold Dagger", "Silver Dagger"]), "Crazy Glue", "Generous Crystal"];
if (chance(30)) shoplist1.push("Six Shooter");
if (chance(30)) shoplist1.push("Sledgehammer");
if (chance(30)) shoplist1.push("Warhammer");
if (chance(30)) shoplist1.push("Thesaurus");
...
var commonlist2 = ["Greenhouse Gas", "Leroy's Boots", "Marshmallow Fluff", "Vantablack", "Gravity", "Roman Candle@ncrmod", "Healer Staff", "Gag Rule", "Two Handed Spatula", "Queen of Diamonds", pick(["Hunting Knife@small", "Hunting Knife@large"]), "Revolver@ncrmod", "Tear Down This Wall", "Vanity Mirror", "Starspear", "Innovate", "Gyrate Hook", "Junk Sword", "Bumpbomb", "Heat Pump", "Shovel", "Boomerang", "Pea Shooter", "Spanner", "Healing Crystal", "Scissors", "Polar Star", "Capacitor", "Puppy Paws", rand(["Scrap Slingshot", "Scrap Trap", "Scrapsies", "Scrapstick", "Scrap Lamp", "Scrap Crystal", "Scraptula", "Scrap Slam", "Scrap Nettle", "Scrap Bump", "Scrap Club", "Scrap Book", "Scrap Spear", "Scrap Kettle", "Scrap Metal"]), "Elastic Heart"];
...
if (getfinalboss() == "Drake"){
  items.push(pick(["Wooden Stake", "Silver Sword"]));
}
