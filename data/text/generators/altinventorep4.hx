...
var shoplist1 = ["Power Glove", "Crush Together", "Survivor's Guilt", "Radio Dial", "Autohook", basics.pop(), "Lightstick", "No Pain No Gain", "Berliner", "Tragic Entrance", "Smartwatch", "Wail Bat", "Crazy Glue", "Generous Crystal"];
...
var commonlist2 = ["Marshmallow Fluff", "Vantablack", "Gravity", "Roman Candle@ncrmod", "Healer Staff", "Gizmotron", "Gag Rule", "Cremator", "Sheer Will", "Revolver@ncrmod", "Tear Down This Wall", "Vanity Mirror", "Gyrate Hook", "Junk Sword", "Bumpbomb", "Heat Pump", scraplist.pop()];
